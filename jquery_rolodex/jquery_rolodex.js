//compresssed rolodex re-positioning into one function and mastered clockwise as well, as all the code is based on the existence of the items, not counters or additions, the js extension is less susceptible to collaspe
